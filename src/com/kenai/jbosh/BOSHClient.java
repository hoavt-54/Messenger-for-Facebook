...
public final class BOSHClient {
    ...
    /**
     * BeemMessage to use for interrupted exceptions.
     */
    private static final String INTERRUPTED = "Interrupted";

    /**
     * BeemMessage used for unhandled exceptions.
     */
    private static final String UNHANDLED = "Unhandled Exception";

    /**
     * BeemMessage used whena null listener is detected.
     */
    ...
    public void send(final ComposableBody body) throws BOSHException {
        ...
        if (body == null) {
            throw(new IllegalArgumentException(
                    "BeemMessage body may not be null"));
        }
