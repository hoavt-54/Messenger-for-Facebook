...
*/
package co.beem.project.beem.providers;
...
public class AvatarProvider extends ContentProvider {
	...
	Uri.parse("content://co.beem.project.beem.providers.avatarprovider");

    /** The MIME type of a CONTENT_URI directory of Beem avatars.  */
    public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.co.beem.project.beem.avatar";

    /** The MIME type of a CONTENT_URI subdirectory of a single Beem avatar.  */
    public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.co.beem.project.beem.avatar";
    ...
    private static final String AUTHORITY = "co.beem.project.beem.providers.avatarprovider";
	...
	File dataPath = new File(cacheDir, "/Android/data/co.beem.project.beem/cache/avatar");
	dataPath.mkdirs();
