...
public class TypingDotsDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawCircle(Utils.dp(3), y, scales[0] * Utils.density, paint);
        canvas.drawCircle(Utils.dp(9), y, scales[1] * Utils.density, paint);
        canvas.drawCircle(Utils.dp(15), y, scales[2] * Utils.density, paint);
        if (started) {
            update();
        }
    }
