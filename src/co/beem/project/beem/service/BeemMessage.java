 ...
 * @author darisk
 */
public class BeemMessage implements Parcelable {
    ...
    public static final Parcelable.Creator<BeemMessage> CREATOR = new Parcelable.Creator<BeemMessage>() {

	@Override
	public BeemMessage createFromParcel(Parcel source) {
	    return new BeemMessage(source);
	}

	@Override
	public BeemMessage[] newArray(int size) {
	    return new BeemMessage[size];
	}
    };
     ...
     */
    public BeemMessage(final String to, final int type) {
	mTo = to;
	mType = type;
	mBody = "";
	mSubject = "";
     ...
     * @param to the destinataire of the message
     */
    public BeemMessage(final String to) {
     ...
     */
    public BeemMessage(final org.jivesoftware.smack.packet.Message smackMsg) {
	this(smackMsg.getTo());
     ...
     */
    private BeemMessage(final Parcel in) {
	mType = in.readInt();
	mTo = in.readString();
	mBody = in.readString();
