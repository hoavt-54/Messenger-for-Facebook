 ...
 * @author darisk
 */
public class Contact implements Parcelable, Contactable {
	...
	public UserState getState() {
		if (getStatus() == co.beem.project.beem.utils.Status.CONTACT_STATUS_AVAILABLE
				|| getStatus() == co.beem.project.beem.utils.Status.CONTACT_STATUS_AVAILABLE_FOR_CHAT) {
	...
	public void setState(UserState state) {
		if (state == UserState.available)
			setStatus(co.beem.project.beem.utils.Status.CONTACT_STATUS_AVAILABLE);
		else 
			setStatus(co.beem.project.beem.utils.Status.CONTACT_STATUS_AVAILABLE);
	}
