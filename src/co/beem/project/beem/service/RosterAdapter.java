...
import co.beem.project.beem.smack.avatar.AvatarManager;
import co.beem.project.beem.smack.avatar.AvatarMetadataExtension.Info;
 ...
 */
public class RosterAdapter extends co.beem.project.beem.service.aidl.IRoster.Stub {
    ...
    /* (non-Javadoc)
     * @see co.beem.project.beem.service.aidl.IRoster#getPresence(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see co.beem.project.beem.service.aidl.IRoster#addContactToGroup(java.lang.String, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see co.beem.project.beem.service.aidl.IRoster#removeContactFromGroup(java.lang.String, java.lang.String)
     */
    @Override
	...
	public void presenceChanged(Presence presence) {
	    ...
	    updateUserState(presence.getFrom(), PresenceType.getPresenceType(presence) == PresenceType.AVAILABLE ? 1 : 0);
	    for (int i = 0; i < n; i++) {
		IBeemRosterListener listener = mRemoteRosListeners.getBroadcastItem(i);
		try {
		    if (listener != null && presence.getStatus() == null || "".equals(presence.getStatus())) {
	...
	public void updateUserState (String jId, int state){
		if (Utils.applicationContext == null) return;
	...
	public void onAvatarChange(String from, String avatarId, List<Info> avatarInfos) {
	    ...
	    Log.v(TAG, "avatar changed from: " + bare);
	    if (avatarId == null)
