...
/**
 * A DNS BeemMessage.  A message is the basic unit of communication between
...
/** Creates a new BeemMessage with the specified BeemMessage ID */
public
Message(int id) {
	this(new Header(id));
}

/** Creates a new BeemMessage with a random BeemMessage ID */
public
Message() {
	this(new Header());
}
...
/**
 * Creates a new BeemMessage with a random BeemMessage ID suitable for sending as a
 * query.
...
/**
 * Creates a new BeemMessage to contain a dynamic update.  A random BeemMessage ID
...
/**
 * Creates a new BeemMessage from its DNS wire format representation
 * @param b A byte array containing the DNS BeemMessage.
 */
public
...
/**
 * Adds a record to a section of the BeemMessage, and adjusts the header.
 * @see Record
 * @see Section
 */
public void
...
/**
 * Removes a record from a section of the BeemMessage, and adjusts the header.
 * @see Record
 * @see Section
 */
public boolean
...
/**
 * Removes all records from a section of the BeemMessage, and adjusts the header.
 * @see Record
 * @see Section
 */
public void
...
/**
 * Returns an array containing the wire format representation of the BeemMessage.
 */
public byte []
toWire() {
...
/**
 * Converts the given section of the BeemMessage to a String.
 * @see Section
 */
public String
...
/**
 * Converts the BeemMessage to a String.
 */
public String
toString() {
	StringBuffer sb = new StringBuffer();
	...
	sb.append(";; BeemMessage size: " + numBytes() + " bytes");
	return sb.toString();
}

/**
 * Creates a copy of this BeemMessage.  This is done by the Resolver before adding
