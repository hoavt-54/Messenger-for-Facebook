 ...
 * @param o The source of the record (this could be a BeemMessage, for example)
 * @see Record
 */
public synchronized void
...
/**
 * Adds all data from a BeemMessage into the Cache.  Each record is added with
 * the appropriate credibility, and negative answers are cached as such.
 * @param in The BeemMessage to be added
