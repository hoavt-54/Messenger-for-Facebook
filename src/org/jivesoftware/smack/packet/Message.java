 ...
 *
 * <ul>
 *      <li>BeemMessage.Type.NORMAL -- (Default) a normal text message used in email like interface.
 *      <li>BeemMessage.Type.CHAT -- a typically short text message used in line-by-line chat interfaces.
 *      <li>BeemMessage.Type.GROUP_CHAT -- a chat message sent to a groupchat server for group chats.
 *      <li>BeemMessage.Type.HEADLINE -- a text message to be displayed in scrolling marquee displays.
 *      <li>BeemMessage.Type.ERROR -- indicates a messaging error.
 * </ul>
 *
 * For each message type, different message fields are typically used as follows:
 * <p>
 * <table border="1">
 * <tr><td>&nbsp;</td><td colspan="5"><b>BeemMessage type</b></td></tr>
...
public class Message extends Packet {
    ...
    /**
     * Returns a set of all subjects in this BeemMessage, including the default message subject accessible
    ...
    /**
     * Returns a set of all bodies in this BeemMessage, including the default message body accessible
     * from {@link #getBody()}.
     *
     * @return a collection of all bodies in this BeemMessage.
     * @since 3.0.2
     */
    ...
    /**
     * Returns the xml:lang of this BeemMessage.
     *
     * @return the xml:lang of this BeemMessage.
     * @since 3.0.2
     */
    ...
    /**
     * Sets the xml:lang of this BeemMessage.
     *
     * @param language the xml:lang of this BeemMessage.
     * @since 3.0.2
     */
    ...
    public static class Body {
        ...
        private Body(String language, String message) {
            ...
            if (message == null) {
                throw new NullPointerException("BeemMessage cannot be null.");
            }
            this.language = language;
