...
public class ReconnectionManager implements ConnectionListener {
	...
	public static boolean isResetTimeout = false;
	
    // Holds the connection to the server
    private Connection connection;
    private Thread reconnectionThread;
    private int randomBase = new Random().nextInt(2) + 2; // between 5 and 15 seconds
        ...
        if (this.isReconnectionAllowed()) {
            ...
            reconnectionThread = new Thread() {
                ...
                private int timeDelay() {
                    attempts++;
                    if (attempts > 30) {
                	return randomBase*5*5;      // between 2.5 and 7.5 minutes (~5 minutes)
                    }
                    if (attempts > 15) {
                	return randomBase*4;       // between 30 and 90 seconds (~1 minutes)
                    }
                ...
                public void run() {
                    ...
                    while (ReconnectionManager.this.isReconnectionAllowed()) {
                    	...
                    	Log.e("ReconnectionManager", "new round to reconnect");
                        ...
                        while (ReconnectionManager.this.isReconnectionAllowed() &&
                                remainingSeconds > 0 && !Utils.isConnectToInternet())
                        {
                            try {
                                Thread.sleep(1000);
                                remainingSeconds--;
                                ...
                                if (ReconnectionManager.isResetTimeout){
                                	remainingSeconds = 1;
                                	attempts = 3;
                                	ReconnectionManager.isResetTimeout = false;
                                }
                            }
                        ...
                        try {
                        	...
                        	Log.e("ReconnectionManager", "reconnect failed");
