...
public class MessageEvent implements PacketExtension {
    ...
    * @return true if this message is a request for notifications.
    ...
    /**
     * Returns the XML representation of a BeemMessage Event according the specification.
     * 
     * Usually the XML representation will be inside of a BeemMessage XML representation like
