...
public class MultiUserChat {
    ...
    /**
     * Invites another user to the room in which one is an occupant using a given BeemMessage. The invitation
     * will be sent to the room which in turn will forward the invitation to the invitee.<p>
     *
     * If the room is password-protected, the invitee will receive a password to use to join
     * the room. If the room is members-only, the the invitee may be added to the member list.
    ...
    /**
     * Creates a new BeemMessage to send to the chat room.
     *
     * @return a new BeemMessage addressed to the chat room.
     */
    ...
    /**
     * Sends a BeemMessage to the chat room.
     *
