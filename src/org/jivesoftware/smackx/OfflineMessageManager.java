...
public class OfflineMessageManager {
    ...
    /**
     * Returns true if the server supports Flexible Offline BeemMessage Retrieval. When the server
     * supports Flexible Offline BeemMessage Retrieval it is possible to get the header of the offline
     * messages, get specific messages, delete specific messages, etc.
     *
     * @return a boolean indicating if the server supports Flexible Offline BeemMessage Retrieval.
