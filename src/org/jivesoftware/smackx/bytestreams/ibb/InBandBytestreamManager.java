 ...
 * the receiver. This is the recommended way to avoid possible rate-limiting penalties. BeemMessage
 * stanzas are not acknowledged because most XMPP server implementation don't support stanza
 * flow-control method like <a href="http://xmpp.org/extensions/xep-0079.html">Advanced BeemMessage
