...
//hong.facebook.messenger
JNIEXPORT void Java_hoahong_facebook_messenger_ui_Utils_loadBitmap(JNIEnv *env, jclass class, jstring path, jintArray bitmap, int scale, int format, int width, int height) {
