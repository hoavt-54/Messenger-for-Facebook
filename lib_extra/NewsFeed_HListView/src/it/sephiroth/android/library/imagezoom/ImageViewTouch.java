...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	protected void onZoomAnimationCompleted(float scale) {
		...
		mZoomingListener.onImageZooming(scale > 1.01 || scale < 0.99);
	}
	...
	public OnZoomImageListener getmZoomingListener() {
		return mZoomingListener;
	}

	public void setmZoomingListener(OnZoomImageListener mZoomingListener) {
	...
	public interface OnZoomImageListener {
		void onImageZooming (boolean isZooming);
	}
}
